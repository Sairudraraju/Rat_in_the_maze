...
void stack_push(int startx, int starty, int **direction) //used to insert an element at the top of the stack
{
    tnode *temp;
...
void stack_pop() //used to remove an element from the top of the stack(newest element in the stack)
{
    tnode *temp;
...
void display_path(int count); //will display the path
...
int main()
{
    ...
    printf("\nEnter the coordinates of start and finish! Eg: (0,0). Remember they must be cells with cell value 0 so that they are traversable!\n");
